...
def build_word_set( input_file ):
    ...
    for line in input_file:
        ...
        # splitting line into list and removing whitespace
        word_lst = line.strip().split()

        # lowering case and stripping punctuation from word in word list
        ...
        for word in word_lst:
            ...
            if word != "":
                ...
                # adds word to unordered set: word_set
                word_set.add( word )
...
def compare_files( file1, file2 ):
    ...
    unique_word_count = len(set1 | set2)
    ...
    # both files.
    unique_word_in_both_count = len(set1 & set2)    
